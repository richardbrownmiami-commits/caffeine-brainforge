 ...
 * Scans gh-latest/src/frontend/src/ for:
...
const ROOT = path.resolve(__dirname, '../../gh-latest/src/frontend/src');
...
for (const filePath of files) {
  ...
  // Matches path: "/some/route" inside createRoute / Route / createFileRoute calls
  ...
  // Also catch: createFileRoute('/path')( pattern
