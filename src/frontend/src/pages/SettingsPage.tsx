...
type Page = null | "api" | "ai" | "termux" | "github" | "pinlock";
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
        ...
        <div className="p-3 rounded-lg border border-emerald-500/20 bg-emerald-500/5 space-y-3">
          ...
          <p className="text-[10px] text-muted-foreground">
            BrainForge stores your data in D1+GitHub. These keys are only for
            apps you build.
          </p>
...
function CustomPromptSection() {
  ...
  // Use draft if actively editing, else show saved value
  ...
  return (
    <div className="p-3 rounded-lg border border-cyan-500/20 bg-cyan-500/5 space-y-3">
      ...
      <p className="text-[10px] text-muted-foreground">
        Appended to every AI request across all projects. Use this to set your
        preferred tone, language, or coding style.
      </p>
      <div className="space-y-1.5">
        <Textarea
          value={value}
          ...
          onBlur={() => {
            if (draft !== null && draft !== savedPrompt) handleSave();
          }}
        ...
        <div className="flex items-center justify-between">
          <span
            className={`text-[10px] tabular-nums ${value.length >= MAX_PROMPT_CHARS ? "text-destructive" : "text-muted-foreground"}`}
          >
          ...
          {showSuccess && (
            <span
              ...
              data-ocid="settings.ai.prompt.success_state"
            >
              Saved ✓
            </span>
          )}
      ...
      <Button
        onClick={handleSave}
        disabled={
          savePrompt.isPending || draft === null || draft === savedPrompt
        }
        className="w-full h-8 text-xs"
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        ...
        <div className="text-center mt-6 space-y-1.5">
          <p className="text-[10px] text-muted-foreground/30">
            Made with love by <span className="text-violet-400/60">Pinka</span>{" "}
