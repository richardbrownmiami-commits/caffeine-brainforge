...
export class Backend implements backendInterface {
    ...
    async getCustomPrompt(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomPrompt();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCustomPrompt(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCustomPrompt(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
